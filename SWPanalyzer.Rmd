...
The wounding moment has to be marked with the F1 key. 
...
Repolarization phase                            
 hyperpol_2nd.amplitude  - Repolarization amplitude from second baseline to peak repolarization.
  bl.2nd                  - Final baseline after SWP is finished
    ...
    INPUT:
Data for one experiment (one day of recordings) regardless of the amount of genotypes analyzed. All the traces 
from plants that grew together and were recorded together are considered to be one experiment.
With this labScribe software and hardware up to 4 electrodes can be used simultaneously. Hence, 2 plants per file. 
Either 1 or 2 plants can be analyzed here, make sure to follow this labeling rules for that.
...
# to find half max frame, substract the halfMax V from the trace and pick the closest to 0.
  ...
  hyperpol_2nd.amplitude = maxRepol-bl.2nd # Find hyperpolarization amplitude in the recovery phase
  # former maxHyperpol2
