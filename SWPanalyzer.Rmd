...
This script transforms and analyzes raw data from electrophysiological recordings of wounded Arabidopsis leafs, which generates signals known as Slow Wave Potential (SWP) [a](https://www.nature.com/articles/nature12478)  . It is designed to manage SWPs recorded with the software LabScribe. The wounding moment has to be marked with the F1 key. 
