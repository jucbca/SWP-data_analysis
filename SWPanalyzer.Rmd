...
Follow these steps to use this script:
  ...
  5. Paste a copy of the exported folders with the ".txt" data from one batch of experiments into the home folder you just created (use format described above in the INPUT section). 
