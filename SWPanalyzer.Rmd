...
# to find half max frame, substract the halfMax V from the trace and pick the closest to 0.
  ...
  # ) #+ stimFrame 
                      ...
                      ### max hyperpol rate
  max.hyperpol.rate = max(depoltrace.firstderivative)
  ### Save time of max slope
  max.slope.frame = min( which(depoltrace.firstderivative == max.hyperpol.rate) )+9
...
```{r}
foldername = "almt5-1-220926" # Replace the text in "" with the name you want your folder to have.
