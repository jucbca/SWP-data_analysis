...
Output -> trace, p1s1.trace, p1s1.trace... for all the files in the folder. 
Saved as >p#s#.csv<
```{r}
setwd(home)
list.files()
...
ggplot(datasummary, aes(`stim.duration`, `tau`, color = `Genotype`, lty = `stim.power` )) +
  geom_violin(size = 1) +
